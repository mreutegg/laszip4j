...
public class LASwriterQFIT extends LASwriter {
    @Override
    ...
    public boolean open(String file_name, LASheader header, int i) {
        return false;
    }

    public boolean open(PrintStream out, LASheader header, int i) {
        return false;
    }
}
