...
public class LASwriterBIN extends LASwriter {
    @Override
    ...
    public boolean open(String file_name, LASheader header, String ts8) {
        return false;
    }

    public boolean open(PrintStream out, LASheader header, String ts8) {
        return false;
    }
}
